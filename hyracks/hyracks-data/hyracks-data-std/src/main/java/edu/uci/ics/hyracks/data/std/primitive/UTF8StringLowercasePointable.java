...
import edu.uci.ics.hyracks.data.std.api.IComparableForStringWithoutLengthByte;
import edu.uci.ics.hyracks.data.std.api.IHashable;
import edu.uci.ics.hyracks.data.std.api.IHashableForStringWithoutLengthByte;
import edu.uci.ics.hyracks.data.std.api.IPointable;
import edu.uci.ics.hyracks.data.std.api.IPointableFactory;

public final class UTF8StringLowercasePointable extends AbstractPointable implements IHashable, IHashableForStringWithoutLengthByte, IComparable, IComparableForStringWithoutLengthByte {
    ...
    // If the length is given, hash() assumes that it only receives the string literal without length (2 byte) in the beginning.
    @Override
